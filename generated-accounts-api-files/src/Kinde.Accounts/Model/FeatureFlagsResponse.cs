...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FeatureFlagsResponse")]
    public partial class FeatureFlagsResponse : IEquatable<FeatureFlagsResponse>, IValidatableObject
    {
        ...
        protected FeatureFlagsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeatureFlagsResponse" /> class.
        /// </summary>
        ...
        public FeatureFlagsResponse(Metadata metadata = default(Metadata), List<FeatureFlag> data = default(List<FeatureFlag>))
        {
            ...
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for FeatureFlagsResponse and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for FeatureFlagsResponse and cannot be null");
            }
            this.Data = data;
        }
