...
namespace Kinde.Accounts.Model
{
    ...
    public partial class Permission : IEquatable<Permission>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Permission" /> class.
        /// </summary>
        /// <param name="id">Unique identifier for the permission (required).</param>
        /// <param name="name">Name of the permission (required).</param>
        /// <param name="description">Description of the permission.</param>
        public Permission(string id = default(string), string name = default(string), string description = default(string))
        {
        ...
        /// </summary>
        /// <value>Unique identifier for the permission</value>
