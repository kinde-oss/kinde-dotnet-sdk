...
namespace Kinde.Accounts.Client
{
    ...
    public class Multimap<TKey, TValue> : IDictionary<TKey, IList<TValue>>
    {
        ...
        {
            // Merge values for existing keys to honor multimap semantics
        ...
        public void Add(Multimap<TKey, TValue> multimap)
        {
            ...
            {
                // Delegate to merge behavior so overlapping keys aggregate values
                Add(item.Key, item.Value);
            }
        }
        ...
        {
            return ((ICollection<KeyValuePair<TKey, IList<TValue>>>)_dictionary).Contains(item);
        }
        ...
        {
            ((ICollection<KeyValuePair<TKey, IList<TValue>>>)_dictionary).CopyTo(array, arrayIndex);
        }
        ...
        {
            return ((ICollection<KeyValuePair<TKey, IList<TValue>>>)_dictionary).Remove(item);
        }
        ...
        public void Add(TKey key, TValue value)
        {
            if (value is null)
            {
                return; // ignore null values for reference types
            }
