...
namespace Kinde.Api.Api
{
    ...
    public interface IFeatureFlagsApiSync : IApiAccessor
    {
        ...
        GetFeatureFlagsResponse GetFeatureFlags(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0);
        ...
        ApiResponse<GetFeatureFlagsResponse> GetFeatureFlagsWithHttpInfo(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IFeatureFlagsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetFeatureFlagsResponse> GetFeatureFlagsAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetFeatureFlagsResponse>> GetFeatureFlagsWithHttpInfoAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace Feature Flag
        /// </summary>
        /// <remarks>
    ...
    public partial class FeatureFlagsApi : IFeatureFlagsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetFeatureFlagsResponse</returns>
        public GetFeatureFlagsResponse GetFeatureFlags(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0)
        {
            Kinde.Api.Client.ApiResponse<GetFeatureFlagsResponse> localVarResponse = GetFeatureFlagsWithHttpInfo(pageSize, startingAfter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetFeatureFlagsResponse</returns>
        public Kinde.Api.Client.ApiResponse<GetFeatureFlagsResponse> GetFeatureFlagsWithHttpInfo(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0)
        {
            Kinde.Api.Client.RequestOptions localVarRequestOptions = new Kinde.Api.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetFeatureFlagsResponse>("/account_api/v1/feature_flags", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetFeatureFlagsResponse</returns>
        public async System.Threading.Tasks.Task<GetFeatureFlagsResponse> GetFeatureFlagsAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Kinde.Api.Client.ApiResponse<GetFeatureFlagsResponse> localVarResponse = await GetFeatureFlagsWithHttpInfoAsync(pageSize, startingAfter, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetFeatureFlagsResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.Api.Client.ApiResponse<GetFeatureFlagsResponse>> GetFeatureFlagsWithHttpInfoAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetFeatureFlagsResponse>("/account_api/v1/feature_flags", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
