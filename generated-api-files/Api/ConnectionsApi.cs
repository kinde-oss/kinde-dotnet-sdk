...
namespace Kinde.Api.Api
{
    ...
    public sealed partial class ConnectionsApi : IConnectionsApi
    {
        ...
        public partial class CreateConnectionApiResponse : Kinde.Api.Client.ApiResponse, ICreateConnectionApiResponse
        {
            ...
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out Kinde.Api.Model.CreateConnectionResponse? result)
            {
                result = null;
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/connections/{connection_id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetConnectionApiResponse : Kinde.Api.Client.ApiResponse, IGetConnectionApiResponse
        {
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Kinde.Api.Model.Connection? result)
            {
                result = null;
