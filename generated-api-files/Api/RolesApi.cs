...
namespace Kinde.Api.Api
{
    ...
    public interface IRolesApiSync : IApiAccessor
    {
        ...
        GetUserRolesResponse GetUserRoles(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0);
        ...
        ApiResponse<GetUserRolesResponse> GetUserRolesWithHttpInfo(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0);
        /// <summary>
    ...
    public interface IRolesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetUserRolesResponse> GetUserRolesAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetUserRolesResponse>> GetUserRolesWithHttpInfoAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove role permission
        /// </summary>
        /// <remarks>
    ...
    public partial class RolesApi : IRolesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetUserRolesResponse</returns>
        public GetUserRolesResponse GetUserRoles(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0)
        {
            Kinde.Api.Client.ApiResponse<GetUserRolesResponse> localVarResponse = GetUserRolesWithHttpInfo(pageSize, startingAfter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetUserRolesResponse</returns>
        public Kinde.Api.Client.ApiResponse<GetUserRolesResponse> GetUserRolesWithHttpInfo(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0)
        {
            Kinde.Api.Client.RequestOptions localVarRequestOptions = new Kinde.Api.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RolesApi.GetUserRoles";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetUserRolesResponse>("/account_api/v1/roles", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserRoles", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetUserRolesResponse</returns>
        public async System.Threading.Tasks.Task<GetUserRolesResponse> GetUserRolesAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Kinde.Api.Client.ApiResponse<GetUserRolesResponse> localVarResponse = await GetUserRolesWithHttpInfoAsync(pageSize, startingAfter, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetUserRolesResponse)</returns>
        public async System.Threading.Tasks.Task<Kinde.Api.Client.ApiResponse<GetUserRolesResponse>> GetUserRolesWithHttpInfoAsync(int? pageSize = default(int?), string? startingAfter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetUserRolesResponse>("/account_api/v1/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
