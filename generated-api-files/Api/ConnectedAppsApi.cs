...
namespace Kinde.Api.Api
{
    ...
    public sealed partial class ConnectedAppsApi : IConnectedAppsApi
    {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                ...
                                apiResponseLocalVar = new GetConnectedAppAuthUrlApiResponse(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/connected_apps/auth_url", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetConnectedAppAuthUrlApiResponse : Kinde.Api.Client.ApiResponse, IGetConnectedAppAuthUrlApiResponse
        {
            ...
            /// <returns></returns>
            public bool TryOk(out Kinde.Api.Model.ConnectedAppsAuthUrl? result)
            {
                result = null;
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryNotFound(out Kinde.Api.Model.ErrorResponse? result)
            {
                result = null;
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync().ConfigureAwait(false);
                                apiResponseLocalVar = new GetConnectedAppTokenApiResponse(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/connected_apps/token", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetConnectedAppTokenApiResponse : Kinde.Api.Client.ApiResponse, IGetConnectedAppTokenApiResponse
        {
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk(out Kinde.Api.Model.ConnectedAppsAccessToken? result)
            {
                result = null;
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync().ConfigureAwait(false);
                                apiResponseLocalVar = new RevokeConnectedAppTokenApiResponse(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/connected_apps/revoke", requestedAtLocalVar, _jsonSerializerOptions);
