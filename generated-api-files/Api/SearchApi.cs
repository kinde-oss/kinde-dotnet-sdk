...
namespace Kinde.Api.Api
{
    ...
    public interface ISearchApiSync : IApiAccessor
    {
        ...
        SearchUsersResponse SearchUsers(int? pageSize = default(int?), string? query = default(string?), Dictionary<string, List<string>>? properties = default(Dictionary<string, List<string>>?), string? startingAfter = default(string?), string? endingBefore = default(string?), string? expand = default(string?), int operationIndex = 0);
        ...
        ApiResponse<SearchUsersResponse> SearchUsersWithHttpInfo(int? pageSize = default(int?), string? query = default(string?), Dictionary<string, List<string>>? properties = default(Dictionary<string, List<string>>?), string? startingAfter = default(string?), string? endingBefore = default(string?), string? expand = default(string?), int operationIndex = 0);
    ...
    public interface ISearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SearchUsersResponse> SearchUsersAsync(int? pageSize = default(int?), string? query = default(string?), Dictionary<string, List<string>>? properties = default(Dictionary<string, List<string>>?), string? startingAfter = default(string?), string? endingBefore = default(string?), string? expand = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SearchApi : ISearchApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SearchUsersResponse</returns>
        public SearchUsersResponse SearchUsers(int? pageSize = default(int?), string? query = default(string?), Dictionary<string, List<string>>? properties = default(Dictionary<string, List<string>>?), string? startingAfter = default(string?), string? endingBefore = default(string?), string? expand = default(string?), int operationIndex = 0)
        {
        ...
        public Kinde.Api.Client.ApiResponse<SearchUsersResponse> SearchUsersWithHttpInfo(int? pageSize = default(int?), string? query = default(string?), Dictionary<string, List<string>>? properties = default(Dictionary<string, List<string>>?), string? startingAfter = default(string?), string? endingBefore = default(string?), string? expand = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SearchApi.SearchUsers";
        ...
        {
            Kinde.Api.Client.ApiResponse<SearchUsersResponse> localVarResponse = await SearchUsersWithHttpInfoAsync(pageSize, query, properties, startingAfter, endingBefore, expand, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
