...
{
    /// <summary>
    /// Newtonsoft.Json converter for UsersResponseUsersInner that handles the Option<> structure
    /// </summary>
    public class UsersResponseUsersInnerNewtonsoftConverter : Newtonsoft.Json.JsonConverter<UsersResponseUsersInner>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override UsersResponseUsersInner ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, UsersResponseUsersInner existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            UsersResponseUsersInnerBilling? billing = default(UsersResponseUsersInnerBilling?);
            if (jsonObject["billing"] != null)
            {
                billing = jsonObject["billing"].ToObject<UsersResponseUsersInnerBilling?>(serializer);
            }

            return new UsersResponseUsersInner(
                id: id != null ? new Option<string?>(id) : default,                 providedId: providedId != null ? new Option<string?>(providedId) : default,                 email: email != null ? new Option<string?>(email) : default,                 phone: phone != null ? new Option<string?>(phone) : default,                 username: username != null ? new Option<string?>(username) : default,                 lastName: lastName != null ? new Option<string?>(lastName) : default,                 firstName: firstName != null ? new Option<string?>(firstName) : default,                 isSuspended: isSuspended != null ? new Option<bool?>(isSuspended) : default,                 picture: picture != null ? new Option<string?>(picture) : default,                 totalSignIns: totalSignIns != null ? new Option<int?>(totalSignIns) : default,                 failedSignIns: failedSignIns != null ? new Option<int?>(failedSignIns) : default,                 lastSignedIn: lastSignedIn != null ? new Option<string?>(lastSignedIn) : default,                 createdOn: createdOn != null ? new Option<string?>(createdOn) : default,                 organizations: organizations != null ? new Option<List<string>?>(organizations) : default,                 identities: identities != null ? new Option<List<UserIdentitiesInner>?>(identities) : default,                 billing: billing != null ? new Option<UsersResponseUsersInnerBilling?>(billing) : default            );
        }

        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, UsersResponseUsersInner value, Newtonsoft.Json.JsonSerializer serializer)
        {
