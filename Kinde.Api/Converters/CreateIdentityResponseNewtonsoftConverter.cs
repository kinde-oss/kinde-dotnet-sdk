...
{
    /// <summary>
    /// Newtonsoft.Json converter for CreateIdentityResponse that handles the Option<> structure
    /// </summary>
    public class CreateIdentityResponseNewtonsoftConverter : Newtonsoft.Json.JsonConverter<CreateIdentityResponse>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override CreateIdentityResponse ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, CreateIdentityResponse existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
