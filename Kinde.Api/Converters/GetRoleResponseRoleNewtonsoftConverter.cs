...
{
    /// <summary>
    /// Newtonsoft.Json converter for GetRoleResponseRole that handles the Option<> structure
    /// </summary>
    public class GetRoleResponseRoleNewtonsoftConverter : Newtonsoft.Json.JsonConverter<GetRoleResponseRole>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override GetRoleResponseRole ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, GetRoleResponseRole existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            return new GetRoleResponseRole(
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, GetRoleResponseRole value, Newtonsoft.Json.JsonSerializer serializer)
        {
