...
{
    /// <summary>
    /// Newtonsoft.Json converter for CreateConnectionRequestOptionsOneOf2 that handles the Option<> structure
    /// </summary>
    public class CreateConnectionRequestOptionsOneOf2NewtonsoftConverter : Newtonsoft.Json.JsonConverter<CreateConnectionRequestOptionsOneOf2>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override CreateConnectionRequestOptionsOneOf2 ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, CreateConnectionRequestOptionsOneOf2 existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            string? samlSignInUrl = default(string?);
            if (jsonObject["saml_sign_in_url"] != null)
            {
                samlSignInUrl = jsonObject["saml_sign_in_url"].ToObject<string?>();
            }
            ...
            bool? isAutoJoinOrganizationEnabled = default(bool?);
            if (jsonObject["is_auto_join_organization_enabled"] != null)
            {
                isAutoJoinOrganizationEnabled = jsonObject["is_auto_join_organization_enabled"].ToObject<bool?>(serializer);
            }

            return new CreateConnectionRequestOptionsOneOf2(
                homeRealmDomains: homeRealmDomains != null ? new Option<List<string>?>(homeRealmDomains) : default,                 samlEntityId: samlEntityId != null ? new Option<string?>(samlEntityId) : default,                 samlAcsUrl: samlAcsUrl != null ? new Option<string?>(samlAcsUrl) : default,                 samlIdpMetadataUrl: samlIdpMetadataUrl != null ? new Option<string?>(samlIdpMetadataUrl) : default,                 samlSignInUrl: samlSignInUrl != null ? new Option<string?>(samlSignInUrl) : default,                 samlEmailKeyAttr: samlEmailKeyAttr != null ? new Option<string?>(samlEmailKeyAttr) : default,                 samlFirstNameKeyAttr: samlFirstNameKeyAttr != null ? new Option<string?>(samlFirstNameKeyAttr) : default,                 samlLastNameKeyAttr: samlLastNameKeyAttr != null ? new Option<string?>(samlLastNameKeyAttr) : default,                 isCreateMissingUser: isCreateMissingUser != null ? new Option<bool?>(isCreateMissingUser) : default,                 isForceShowSsoButton: isForceShowSsoButton != null ? new Option<bool?>(isForceShowSsoButton) : default,                 upstreamParams: upstreamParams != null ? new Option<Dictionary<string, Object>>(upstreamParams) : default,                 samlSigningCertificate: samlSigningCertificate != null ? new Option<string?>(samlSigningCertificate) : default,                 samlSigningPrivateKey: samlSigningPrivateKey != null ? new Option<string?>(samlSigningPrivateKey) : default,                 isAutoJoinOrganizationEnabled: isAutoJoinOrganizationEnabled != null ? new Option<bool?>(isAutoJoinOrganizationEnabled) : default            );
        }

        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, CreateConnectionRequestOptionsOneOf2 value, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            if (value.SamlSignInUrlOption.IsSet && value.SamlSignInUrl != null)
            {
                writer.WritePropertyName("saml_sign_in_url");
                serializer.Serialize(writer, value.SamlSignInUrl);
            }
            ...
            if (value.IsAutoJoinOrganizationEnabledOption.IsSet && value.IsAutoJoinOrganizationEnabled != null)
            {
                writer.WritePropertyName("is_auto_join_organization_enabled");
                serializer.Serialize(writer, value.IsAutoJoinOrganizationEnabled);
            }
