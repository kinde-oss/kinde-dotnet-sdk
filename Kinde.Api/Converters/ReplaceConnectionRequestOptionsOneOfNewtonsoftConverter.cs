...
{
    /// <summary>
    /// Newtonsoft.Json converter for ReplaceConnectionRequestOptionsOneOf that handles the Option<> structure
    /// </summary>
    public class ReplaceConnectionRequestOptionsOneOfNewtonsoftConverter : Newtonsoft.Json.JsonConverter<ReplaceConnectionRequestOptionsOneOf>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override ReplaceConnectionRequestOptionsOneOf ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, ReplaceConnectionRequestOptionsOneOf existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            return new ReplaceConnectionRequestOptionsOneOf(
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, ReplaceConnectionRequestOptionsOneOf value, Newtonsoft.Json.JsonSerializer serializer)
        {
