...
{
    /// <summary>
    /// Newtonsoft.Json converter for CreateConnectionRequestOptionsOneOf1 that handles the Option<> structure
    /// </summary>
    public class CreateConnectionRequestOptionsOneOf1NewtonsoftConverter : Newtonsoft.Json.JsonConverter<CreateConnectionRequestOptionsOneOf1>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override CreateConnectionRequestOptionsOneOf1 ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, CreateConnectionRequestOptionsOneOf1 existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
