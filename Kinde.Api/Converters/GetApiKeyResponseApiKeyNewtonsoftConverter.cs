...
{
    /// <summary>
    /// Newtonsoft.Json converter for GetApiKeyResponseApiKey that handles the Option<> structure
    /// </summary>
    public class GetApiKeyResponseApiKeyNewtonsoftConverter : Newtonsoft.Json.JsonConverter<GetApiKeyResponseApiKey>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override GetApiKeyResponseApiKey ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, GetApiKeyResponseApiKey existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            if (jsonObject["organization_id"] != null)
            {
                organizationId = jsonObject["organization_id"].ToObject<string?>();
            }
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, GetApiKeyResponseApiKey value, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            if (value.OrganizationIdOption.IsSet && value.OrganizationId != null)
            {
                writer.WritePropertyName("organization_id");
                serializer.Serialize(writer, value.OrganizationId);
            }
