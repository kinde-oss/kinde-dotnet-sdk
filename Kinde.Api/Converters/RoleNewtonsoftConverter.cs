...
{
    /// <summary>
    /// Newtonsoft.Json converter for Role that handles the Option<> structure
    /// </summary>
    public class RoleNewtonsoftConverter : Newtonsoft.Json.JsonConverter<Role>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override Role ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, Role existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, Role value, Newtonsoft.Json.JsonSerializer serializer)
        {
