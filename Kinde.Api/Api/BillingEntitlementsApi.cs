...
private Kinde.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        public async System.Threading.Tasks.Task<Kinde.Api.Client.ApiResponse<GetBillingEntitlementsResponse>> GetBillingEntitlementsWithHttpInfoAsync(string customerId, int? pageSize = default(int?), string startingAfter = default(string), string endingBefore = default(string), string maxValue = default(string), string expand = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                Kiota.Management.Api.V1.Billing.Entitlements.GetExpandQueryParameterType? kiotaExpand = null;
                if (expand != null && Enum.TryParse<Kiota.Management.Api.V1.Billing.Entitlements.GetExpandQueryParameterType>(expand, true, out var parsedExpand))
                {
                    kiotaExpand = parsedExpand;
                }

                var kiotaResponse = await KiotaClient.Api.V1.Billing.Entitlements.GetAsync(config =>
                {
                    ...
                    config.QueryParameters.MaxValue = maxValue;
                    config.QueryParameters.Expand = kiotaExpand;
                }, cancellationToken).ConfigureAwait(false);

                var mappedResponse = KiotaMapper.Map<GetBillingEntitlementsResponse>(kiotaResponse);
                return new Kinde.Api.Client.ApiResponse<GetBillingEntitlementsResponse>(
            ...
            {
                throw new Kinde.Api.Client.ApiException((int)ex.ResponseStatusCode, $"Error calling GetBillingEntitlements: {ex.Message}", ex);
            }
        }
