...
namespace Kinde.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddAPIsRequest :  IEquatable<AddAPIsRequest>
    {
        /// <summary>
        ...
        public AddAPIsRequest(string name = default(string), string audience = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AddAPIsRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (audience == null)
            {
                throw new InvalidDataException("audience is a required property for AddAPIsRequest and cannot be null");
            }
            else
            {
