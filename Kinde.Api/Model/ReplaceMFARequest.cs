...
namespace Kinde.Api.Model
{
    ...
    public partial class ReplaceMFARequest :  IEquatable<ReplaceMFARequest>
    {
        ...
        public ReplaceMFARequest(PolicyEnum policy = default(PolicyEnum), List<EnabledFactorsEnum> enabledFactors = default(List<EnabledFactorsEnum>))
        {
            ...
            if (policy == null)
            {
                throw new InvalidDataException("policy is a required property for ReplaceMFARequest and cannot be null");
            }
            else
            {
                this.Policy = policy;
            ...
            {
                throw new InvalidDataException("enabledFactors is a required property for ReplaceMFARequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="enabled_factors", EmitDefaultValue=true)]
