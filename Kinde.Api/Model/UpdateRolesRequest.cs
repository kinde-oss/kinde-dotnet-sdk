...
namespace Kinde.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateRolesRequest :  IEquatable<UpdateRolesRequest>
    {
        /// <summary>
        ...
        public UpdateRolesRequest(string name = default(string), string description = default(string), string key = default(string), bool isDefaultRole = default(bool), Guid? assignmentPermissionId = default(Guid?))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UpdateRolesRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for UpdateRolesRequest and cannot be null");
            }
            else
            {
                this.Key = key;
