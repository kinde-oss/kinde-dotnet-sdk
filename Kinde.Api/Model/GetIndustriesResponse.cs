...
namespace Kinde.Api.Model
{
    ...
    public partial class GetIndustriesResponse : IEquatable<GetIndustriesResponse>, IValidatableObject
    {
        ...
        public GetIndustriesResponse(string code = default(string), string message = default(string), List<GetIndustriesResponseIndustriesInner> industries = default(List<GetIndustriesResponseIndustriesInner>))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as GetIndustriesResponse);
        }
