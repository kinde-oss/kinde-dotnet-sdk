...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateEnvironmentVariableRequest :  IEquatable<CreateEnvironmentVariableRequest>
    {
        ...
        public CreateEnvironmentVariableRequest(string key = default(string), string value = default(string), bool isSecret = default(bool))
        {
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for CreateEnvironmentVariableRequest and cannot be null");
            }
            else
            {
                this.Key = key;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CreateEnvironmentVariableRequest and cannot be null");
            }
            else
            {
                this.Value = value;
