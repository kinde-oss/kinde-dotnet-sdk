...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateWebHookRequest : IEquatable<CreateWebHookRequest>
    {
        ...
        /// <param name="name">The webhook name (required).</param>
        /// <param name="description">The webhook description.</param>
        public CreateWebHookRequest(string endpoint = default(string), List<string> eventTypes = default(List<string>), string name = default(string), string description = default(string))
        {
            // to ensure "endpoint" is required (not null)
            if (endpoint == null)
            {
                throw new ArgumentNullException("endpoint is a required property for CreateWebHookRequest and cannot be null");
            }
            this.Endpoint = endpoint;
            // to ensure "eventTypes" is required (not null)
            if (eventTypes == null)
            {
                throw new ArgumentNullException("eventTypes is a required property for CreateWebHookRequest and cannot be null");
            }
