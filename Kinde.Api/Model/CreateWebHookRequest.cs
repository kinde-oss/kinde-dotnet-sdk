...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateWebHookRequest :  IEquatable<CreateWebHookRequest>
    {
        ...
        public CreateWebHookRequest(string endpoint = default(string), List<string> eventTypes = default(List<string>), string name = default(string), string description = default(string))
        {
            ...
            if (endpoint == null)
            {
                throw new InvalidDataException("endpoint is a required property for CreateWebHookRequest and cannot be null");
            }
            else
            {
            ...
            if (eventTypes == null)
            {
                throw new InvalidDataException("eventTypes is a required property for CreateWebHookRequest and cannot be null");
            }
            else
            {
