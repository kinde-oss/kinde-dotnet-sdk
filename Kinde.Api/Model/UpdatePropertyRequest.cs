...
namespace Kinde.Api.Model
{
    ...
    public partial class UpdatePropertyRequest :  IEquatable<UpdatePropertyRequest>
    {
        ...
        public UpdatePropertyRequest(string name = default(string), string description = default(string), bool isPrivate = default(bool), string categoryId = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UpdatePropertyRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (isPrivate == null)
            {
                throw new InvalidDataException("isPrivate is a required property for UpdatePropertyRequest and cannot be null");
            }
            else
            {
            ...
            if (categoryId == null)
            {
                throw new InvalidDataException("categoryId is a required property for UpdatePropertyRequest and cannot be null");
            }
            else
            {
