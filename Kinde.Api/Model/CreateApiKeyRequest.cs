...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateApiKeyRequest : IEquatable<CreateApiKeyRequest>
    {
        ...
        /// </summary>
        /// <value>The entity type that will use this API key.</value>
        ...
        /// <param name="type">The entity type that will use this API key. (required).</param>
        ...
        public CreateApiKeyRequest(string name = default(string), TypeEnum type = default(TypeEnum), string apiId = default(string), List<string> scopeIds = default(List<string>), string userId = default(string), string orgCode = default(string))
        {
