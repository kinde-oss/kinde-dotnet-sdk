...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateApiKeyRequest :  IEquatable<CreateApiKeyRequest>
    {
        ...
        public CreateApiKeyRequest(string name = default(string), string apiId = default(string), List<string> scopeIds = default(List<string>), string userId = default(string), string orgCode = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateApiKeyRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (apiId == null)
            {
                throw new InvalidDataException("apiId is a required property for CreateApiKeyRequest and cannot be null");
            }
            else
            {
                this.ApiId = apiId;
