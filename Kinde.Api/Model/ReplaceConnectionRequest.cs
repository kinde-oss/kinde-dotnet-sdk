...
namespace Kinde.Api.Model
{
    ...
    public partial class ReplaceConnectionRequest : IEquatable<ReplaceConnectionRequest>, IValidatableObject
    {
        ...
        public ReplaceConnectionRequest(string name = default(string), string displayName = default(string), List<string> enabledApplications = default(List<string>), CreateConnectionRequestOptions options = default(CreateConnectionRequestOptions))
        {
            this.Name = name;
