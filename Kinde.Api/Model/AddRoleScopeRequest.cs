...
namespace Kinde.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddRoleScopeRequest :  IEquatable<AddRoleScopeRequest>
    {
        /// <summary>
        ...
        public AddRoleScopeRequest(string scopeId = default(string))
        {
            ...
            if (scopeId == null)
            {
                throw new InvalidDataException("scopeId is a required property for AddRoleScopeRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="scope_id", EmitDefaultValue=true)]
