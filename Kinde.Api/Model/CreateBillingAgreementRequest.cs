...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateBillingAgreementRequest :  IEquatable<CreateBillingAgreementRequest>
    {
        ...
        public CreateBillingAgreementRequest(string customerId = default(string), string planCode = default(string), bool isInvoiceNow = default(bool), bool isProrate = default(bool))
        {
            ...
            if (customerId == null)
            {
                throw new InvalidDataException("customerId is a required property for CreateBillingAgreementRequest and cannot be null");
            }
            else
            {
            ...
            if (planCode == null)
            {
                throw new InvalidDataException("planCode is a required property for CreateBillingAgreementRequest and cannot be null");
            }
            else
            {
