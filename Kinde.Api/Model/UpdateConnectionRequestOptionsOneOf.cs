...
namespace Kinde.Api.Model
{
    ...
    /// </summary>
    public partial class UpdateConnectionRequestOptionsOneOf
    {
        /// <summary>
        ...
        public string? EntraIdDomain { get { return this.EntraIdDomainOption; } set { this.EntraIdDomainOption = new Option<string?>(value); } }
        ...
        public bool? IsUseCommonEndpoint { get { return this.IsUseCommonEndpointOption; } set { this.IsUseCommonEndpointOption = new Option<bool?>(value); } }
        ...
        public bool? IsSyncUserProfileOnLogin { get { return this.IsSyncUserProfileOnLoginOption; } set { this.IsSyncUserProfileOnLoginOption = new Option<bool?>(value); } }
        ...
        public bool? IsRetrieveProviderUserGroups { get { return this.IsRetrieveProviderUserGroupsOption; } set { this.IsRetrieveProviderUserGroupsOption = new Option<bool?>(value); } }
        ...
        public bool? IsExtendedAttributesRequired { get { return this.IsExtendedAttributesRequiredOption; } set { this.IsExtendedAttributesRequiredOption = new Option<bool?>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateConnectionRequestOptionsOneOf" />
    /// </summary>
    public class UpdateConnectionRequestOptionsOneOfJsonConverter : JsonConverter<UpdateConnectionRequestOptionsOneOf>
    {
        /// <summary>
        /// Deserializes json to <see cref="UpdateConnectionRequestOptionsOneOf" />
        /// </summary>
        ...
        public override UpdateConnectionRequestOptionsOneOf Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (clientId.IsSet && clientId.Value == null)
                throw new ArgumentNullException(nameof(clientId), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (clientSecret.IsSet && clientSecret.Value == null)
                throw new ArgumentNullException(nameof(clientSecret), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (homeRealmDomains.IsSet && homeRealmDomains.Value == null)
                throw new ArgumentNullException(nameof(homeRealmDomains), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (entraIdDomain.IsSet && entraIdDomain.Value == null)
                throw new ArgumentNullException(nameof(entraIdDomain), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isUseCommonEndpoint.IsSet && isUseCommonEndpoint.Value == null)
                throw new ArgumentNullException(nameof(isUseCommonEndpoint), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isSyncUserProfileOnLogin.IsSet && isSyncUserProfileOnLogin.Value == null)
                throw new ArgumentNullException(nameof(isSyncUserProfileOnLogin), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isRetrieveProviderUserGroups.IsSet && isRetrieveProviderUserGroups.Value == null)
                throw new ArgumentNullException(nameof(isRetrieveProviderUserGroups), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isExtendedAttributesRequired.IsSet && isExtendedAttributesRequired.Value == null)
                throw new ArgumentNullException(nameof(isExtendedAttributesRequired), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isCreateMissingUser.IsSet && isCreateMissingUser.Value == null)
                throw new ArgumentNullException(nameof(isCreateMissingUser), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (isForceShowSsoButton.IsSet && isForceShowSsoButton.Value == null)
                throw new ArgumentNullException(nameof(isForceShowSsoButton), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            if (upstreamParams.IsSet && upstreamParams.Value == null)
                throw new ArgumentNullException(nameof(upstreamParams), "Property is not nullable for class UpdateConnectionRequestOptionsOneOf.");

            return new UpdateConnectionRequestOptionsOneOf(clientId, clientSecret, homeRealmDomains, entraIdDomain, isUseCommonEndpoint, isSyncUserProfileOnLogin, isRetrieveProviderUserGroups, isExtendedAttributesRequired, isCreateMissingUser, isForceShowSsoButton, upstreamParams);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateConnectionRequestOptionsOneOf" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateConnectionRequestOptionsOneOf"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateConnectionRequestOptionsOneOf updateConnectionRequestOptionsOneOf, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateConnectionRequestOptionsOneOf, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateConnectionRequestOptionsOneOf" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateConnectionRequestOptionsOneOf"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateConnectionRequestOptionsOneOf updateConnectionRequestOptionsOneOf, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateConnectionRequestOptionsOneOf.ClientIdOption.IsSet && updateConnectionRequestOptionsOneOf.ClientId == null)
                throw new ArgumentNullException(nameof(updateConnectionRequestOptionsOneOf.ClientId), "Property is required for class UpdateConnectionRequestOptionsOneOf.");

            if (updateConnectionRequestOptionsOneOf.ClientSecretOption.IsSet && updateConnectionRequestOptionsOneOf.ClientSecret == null)
                throw new ArgumentNullException(nameof(updateConnectionRequestOptionsOneOf.ClientSecret), "Property is required for class UpdateConnectionRequestOptionsOneOf.");

            if (updateConnectionRequestOptionsOneOf.HomeRealmDomainsOption.IsSet && updateConnectionRequestOptionsOneOf.HomeRealmDomains == null)
                throw new ArgumentNullException(nameof(updateConnectionRequestOptionsOneOf.HomeRealmDomains), "Property is required for class UpdateConnectionRequestOptionsOneOf.");

            if (updateConnectionRequestOptionsOneOf.EntraIdDomainOption.IsSet && updateConnectionRequestOptionsOneOf.EntraIdDomain == null)
                throw new ArgumentNullException(nameof(updateConnectionRequestOptionsOneOf.EntraIdDomain), "Property is required for class UpdateConnectionRequestOptionsOneOf.");

            if (updateConnectionRequestOptionsOneOf.UpstreamParamsOption.IsSet && updateConnectionRequestOptionsOneOf.UpstreamParams == null)
                throw new ArgumentNullException(nameof(updateConnectionRequestOptionsOneOf.UpstreamParams), "Property is required for class UpdateConnectionRequestOptionsOneOf.");

            if (updateConnectionRequestOptionsOneOf.ClientIdOption.IsSet)
                writer.WriteString("client_id", updateConnectionRequestOptionsOneOf.ClientId);

            if (updateConnectionRequestOptionsOneOf.ClientSecretOption.IsSet)
                writer.WriteString("client_secret", updateConnectionRequestOptionsOneOf.ClientSecret);

            if (updateConnectionRequestOptionsOneOf.HomeRealmDomainsOption.IsSet)
            {
                writer.WritePropertyName("home_realm_domains");
                JsonSerializer.Serialize(writer, updateConnectionRequestOptionsOneOf.HomeRealmDomains, jsonSerializerOptions);
            }
            if (updateConnectionRequestOptionsOneOf.EntraIdDomainOption.IsSet)
                writer.WriteString("entra_id_domain", updateConnectionRequestOptionsOneOf.EntraIdDomain);

            if (updateConnectionRequestOptionsOneOf.IsUseCommonEndpointOption.IsSet)
                writer.WriteBoolean("is_use_common_endpoint", updateConnectionRequestOptionsOneOf.IsUseCommonEndpointOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.IsSyncUserProfileOnLoginOption.IsSet)
                writer.WriteBoolean("is_sync_user_profile_on_login", updateConnectionRequestOptionsOneOf.IsSyncUserProfileOnLoginOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.IsRetrieveProviderUserGroupsOption.IsSet)
                writer.WriteBoolean("is_retrieve_provider_user_groups", updateConnectionRequestOptionsOneOf.IsRetrieveProviderUserGroupsOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.IsExtendedAttributesRequiredOption.IsSet)
                writer.WriteBoolean("is_extended_attributes_required", updateConnectionRequestOptionsOneOf.IsExtendedAttributesRequiredOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.IsCreateMissingUserOption.IsSet)
                writer.WriteBoolean("is_create_missing_user", updateConnectionRequestOptionsOneOf.IsCreateMissingUserOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.IsForceShowSsoButtonOption.IsSet)
                writer.WriteBoolean("is_force_show_sso_button", updateConnectionRequestOptionsOneOf.IsForceShowSsoButtonOption.Value!.Value);

            if (updateConnectionRequestOptionsOneOf.UpstreamParamsOption.IsSet)
            {
                writer.WritePropertyName("upstream_params");
                JsonSerializer.Serialize(writer, updateConnectionRequestOptionsOneOf.UpstreamParams, jsonSerializerOptions);
            }
        }
    }
}
