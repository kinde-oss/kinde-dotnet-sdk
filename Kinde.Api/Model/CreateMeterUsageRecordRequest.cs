...
namespace Kinde.Api.Model
{
    ...
    public partial class CreateMeterUsageRecordRequest :  IEquatable<CreateMeterUsageRecordRequest>
    {
        ...
        public CreateMeterUsageRecordRequest(string customerAgreementId = default(string), string billingFeatureCode = default(string), string meterValue = default(string), DateTimeOffset meterUsageTimestamp = default(DateTimeOffset), MeterTypeCodeEnum? meterTypeCode = default(MeterTypeCodeEnum?))
        {
            ...
            {
                throw new InvalidDataException("customerAgreementId is a required property for CreateMeterUsageRecordRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("billingFeatureCode is a required property for CreateMeterUsageRecordRequest and cannot be null");
            }
            else
            {
            ...
            if (meterValue == null)
            {
                throw new InvalidDataException("meterValue is a required property for CreateMeterUsageRecordRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="customer_agreement_id", EmitDefaultValue=true)]
        ...
        [DataMember(Name="billing_feature_code", EmitDefaultValue=true)]
        ...
        [DataMember(Name="meter_value", EmitDefaultValue=true)]
