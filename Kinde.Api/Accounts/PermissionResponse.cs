...
namespace Kinde.Accounts.Model
{
    ...
    /// PermissionResponse
    /// </summary>
    [DataContract(Name = "PermissionResponse")]
    public partial class PermissionResponse : IEquatable<PermissionResponse>, IValidatableObject
    {
        ...
        public PermissionResponse(Permission data = default(Permission))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for PermissionResponse and cannot be null");
            }
            this.Data = data;
        }
