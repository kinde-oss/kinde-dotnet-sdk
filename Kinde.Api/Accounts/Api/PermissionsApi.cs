...
namespace Kinde.Accounts.Api
{
    ...
    public interface IPermissionsApi : IApi
    {
        ...
        /// <returns><see cref="Task"/><<see cref="IGetUserPermissionsApiResponse"/>></returns>
        Task<IGetUserPermissionsApiResponse> GetUserPermissionsAsync(Option<int?> pageSize = default, Option<string?> startingAfter = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/><<see cref="IGetUserPermissionsApiResponse"/>?></returns>
        Task<IGetUserPermissionsApiResponse?> GetUserPermissionsOrDefaultAsync(Option<int?> pageSize = default, Option<string?> startingAfter = default, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetUserPermissionsApiResponse"/>
    /// </summary>
    public interface IGetUserPermissionsApiResponse : Kinde.Accounts.Client.IApiResponse, IOk<Kinde.Accounts.Model.GetUserPermissionsResponse?>
    {
        /// <summary>
    ...
    public class PermissionsApiEvents
    {
        ...
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetUserPermissions;
        ...
        internal void ExecuteOnGetUserPermissions(PermissionsApi.GetUserPermissionsApiResponse apiResponse)
        {
            OnGetUserPermissions?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }
    ...
    public sealed partial class PermissionsApi : IPermissionsApi
    {
        ...
        private void AfterGetUserPermissionsDefaultImplementation(IGetUserPermissionsApiResponse apiResponseLocalVar, Option<int?> pageSize, Option<string?> startingAfter)
        {
        ...
        /// <param name="pageSize"></param>
        /// <param name="startingAfter"></param>
        partial void AfterGetUserPermissions(ref bool suppressDefaultLog, IGetUserPermissionsApiResponse apiResponseLocalVar, Option<int?> pageSize, Option<string?> startingAfter);
        ...
        /// <param name="pageSize"></param>
        /// <param name="startingAfter"></param>
        private void OnErrorGetUserPermissionsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int?> pageSize, Option<string?> startingAfter)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetUserPermissions(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, pageSize, startingAfter);
        ...
        /// <param name="pageSize"></param>
        /// <param name="startingAfter"></param>
        partial void OnErrorGetUserPermissions(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int?> pageSize, Option<string?> startingAfter);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/><<see cref="IGetUserPermissionsApiResponse"/>></returns>
        public async Task<IGetUserPermissionsApiResponse?> GetUserPermissionsOrDefaultAsync(Option<int?> pageSize = default, Option<string?> startingAfter = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/><<see cref="IGetUserPermissionsApiResponse"/>></returns>
        public async Task<IGetUserPermissionsApiResponse> GetUserPermissionsAsync(Option<int?> pageSize = default, Option<string?> startingAfter = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/account_api/v1/permissions");
                    ...
                    {
                        ILogger<GetUserPermissionsApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetUserPermissionsApiResponse>();
                        GetUserPermissionsApiResponse apiResponseLocalVar;
        ...
        /// <summary>
        /// The <see cref="GetUserPermissionsApiResponse"/>
        /// </summary>
        public partial class GetUserPermissionsApiResponse : Kinde.Accounts.Client.ApiResponse, IGetUserPermissionsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetUserPermissionsApiResponse> Logger { get; }
            ...
            public GetUserPermissionsApiResponse(ILogger<GetUserPermissionsApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
            ...
            /// </summary>
            /// <returns></returns>
            public Kinde.Accounts.Model.GetUserPermissionsResponse? Ok()
            {
