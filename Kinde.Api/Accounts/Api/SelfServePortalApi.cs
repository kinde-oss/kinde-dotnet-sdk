...
namespace Kinde.Accounts.Api
{
    ...
    public sealed partial class SelfServePortalApi : ISelfServePortalApi
    {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                ...
                                apiResponseLocalVar = new GetPortalLinkApiResponse(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/account_api/v1/portal_link", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetPortalLinkApiResponse : Kinde.Accounts.Client.ApiResponse, IGetPortalLinkApiResponse
        {
            ...
            /// <returns></returns>
            public bool TryOk(out Kinde.Accounts.Model.PortalLink? result)
            {
                result = null;
