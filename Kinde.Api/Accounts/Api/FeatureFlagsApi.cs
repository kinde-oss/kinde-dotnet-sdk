...
namespace Kinde.Accounts.Api
{
    ...
    public sealed partial class FeatureFlagsApi : IFeatureFlagsApi
    {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                ...
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/account_api/v1/feature_flags", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetFeatureFlagsApiResponse : Kinde.Accounts.Client.ApiResponse, IGetFeatureFlagsApiResponse
        {
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Kinde.Accounts.Model.GetFeatureFlagsResponse? result)
            {
                result = null;
