...
{
    /// <summary>
    /// Newtonsoft.Json converter for GetEntitlementsResponseMetadata that handles the Option<> structure
    /// </summary>
    public class GetEntitlementsResponseMetadataNewtonsoftConverter : Newtonsoft.Json.JsonConverter<GetEntitlementsResponseMetadata>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override GetEntitlementsResponseMetadata ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, GetEntitlementsResponseMetadata existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            return new GetEntitlementsResponseMetadata(
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, GetEntitlementsResponseMetadata value, Newtonsoft.Json.JsonSerializer serializer)
        {
