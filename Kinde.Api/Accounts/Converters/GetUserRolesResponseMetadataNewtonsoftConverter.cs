...
{
    /// <summary>
    /// Newtonsoft.Json converter for GetUserRolesResponseMetadata that handles the Option<> structure
    /// </summary>
    public class GetUserRolesResponseMetadataNewtonsoftConverter : Newtonsoft.Json.JsonConverter<GetUserRolesResponseMetadata>
    {
        public override bool CanRead => true;
        public override bool CanWrite => true;

        public override GetUserRolesResponseMetadata ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, GetUserRolesResponseMetadata existingValue, bool hasExistingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            return new GetUserRolesResponseMetadata(
        ...
        public override void WriteJson(Newtonsoft.Json.JsonWriter writer, GetUserRolesResponseMetadata value, Newtonsoft.Json.JsonSerializer serializer)
        {
