...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserPermissionsResponseMetadata :  IEquatable<GetUserPermissionsResponseMetadata>
    {
        /// <summary>
        ...
        public GetUserPermissionsResponseMetadata(bool hasMore = default(bool), string nextPageStartingAfter = default(string))
        {
        ...
        {
            return this.Equals(input as GetUserPermissionsResponseMetadata);
        }

        /// <summary>
        /// Returns true if GetUserPermissionsResponseMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserPermissionsResponseMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserPermissionsResponseMetadata input)
        {
            if (input == null)
                return false;
