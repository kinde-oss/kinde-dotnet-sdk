...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserPropertiesResponseDataPropertiesInnerValue :  IEquatable<GetUserPropertiesResponseDataPropertiesInnerValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserPropertiesResponseDataPropertiesInnerValue" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public GetUserPropertiesResponseDataPropertiesInnerValue()
        {
        }
        ...
        {
            return this.Equals(input as GetUserPropertiesResponseDataPropertiesInnerValue);
        }

        /// <summary>
        /// Returns true if GetUserPropertiesResponseDataPropertiesInnerValue instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserPropertiesResponseDataPropertiesInnerValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserPropertiesResponseDataPropertiesInnerValue input)
        {
            if (input == null)
                return false;
