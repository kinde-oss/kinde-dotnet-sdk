...
namespace Kinde.Accounts.Model
{
    ...
    public partial class PortalLink :  IEquatable<PortalLink>
    {
        ...
        {
            return this.Equals(input as PortalLink);
        }

        /// <summary>
        /// Returns true if PortalLink instances are equal
        /// </summary>
        /// <param name="input">Instance of PortalLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortalLink input)
        {
            if (input == null)
                return false;
