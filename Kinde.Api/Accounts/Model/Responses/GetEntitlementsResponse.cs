...
namespace Kinde.Accounts.Model.Responses
{
    ...
    public partial class GetEntitlementsResponse
    {
        ...
        [JsonConstructor]
        public GetEntitlementsResponse(GetEntitlementsResponseData data, GetEntitlementsResponseMetadata metadata)
        {
            Data = data;
            Metadata = metadata;
            OnCreated();
        ...
        public GetEntitlementsResponseData Data { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [JsonPropertyName("metadata")]
        public GetEntitlementsResponseMetadata Metadata { get; set; }
    ...
    public class GetEntitlementsResponseJsonConverter : JsonConverter<GetEntitlementsResponse>
    {
        ...
        public override GetEntitlementsResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            GetEntitlementsResponseData? data = default;
            GetEntitlementsResponseMetadata? metadata = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "data":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                data = JsonSerializer.Deserialize<GetEntitlementsResponseData>(ref utf8JsonReader, jsonSerializerOptions);
                            break;
                        case "metadata":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                metadata = JsonSerializer.Deserialize<GetEntitlementsResponseMetadata>(ref utf8JsonReader, jsonSerializerOptions);
                            break;
                        default:
                            break;
                    }
            ...
            if (data == null)
                throw new ArgumentNullException(nameof(data), "Property is required for class GetEntitlementsResponse.");

            if (metadata == null)
                throw new ArgumentNullException(nameof(metadata), "Property is required for class GetEntitlementsResponse.");
        ...
        public override void Write(Utf8JsonWriter writer, GetEntitlementsResponse getEntitlementsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(ref writer, getEntitlementsResponse, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(ref Utf8JsonWriter writer, GetEntitlementsResponse getEntitlementsResponse, JsonSerializerOptions jsonSerializerOptions)
        {
