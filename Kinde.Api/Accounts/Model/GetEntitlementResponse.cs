...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetEntitlementResponse :  IEquatable<GetEntitlementResponse>
    {
        /// <summary>
        ...
        public GetEntitlementResponse(GetEntitlementResponseData data = default(GetEntitlementResponseData), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as GetEntitlementResponse);
        }

        /// <summary>
        /// Returns true if GetEntitlementResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEntitlementResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEntitlementResponse input)
        {
            if (input == null)
                return false;
