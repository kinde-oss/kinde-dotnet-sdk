...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserPermissionsResponse :  IEquatable<GetUserPermissionsResponse>
    {
        /// <summary>
        ...
        public GetUserPermissionsResponse(GetUserPermissionsResponseData data = default(GetUserPermissionsResponseData), GetUserPermissionsResponseMetadata metadata = default(GetUserPermissionsResponseMetadata))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as GetUserPermissionsResponse);
        }

        /// <summary>
        /// Returns true if GetUserPermissionsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserPermissionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserPermissionsResponse input)
        {
            if (input == null)
                return false;
