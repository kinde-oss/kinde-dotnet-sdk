...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetEntitlementsResponseMetadata :  IEquatable<GetEntitlementsResponseMetadata>
    {
        /// <summary>
        ...
        public GetEntitlementsResponseMetadata(bool hasMore = default(bool), string nextPageStartingAfter = default(string))
        {
        ...
        {
            return this.Equals(input as GetEntitlementsResponseMetadata);
        }

        /// <summary>
        /// Returns true if GetEntitlementsResponseMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEntitlementsResponseMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEntitlementsResponseMetadata input)
        {
            if (input == null)
                return false;
