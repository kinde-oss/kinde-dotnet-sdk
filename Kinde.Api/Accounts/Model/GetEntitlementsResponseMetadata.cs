...
namespace Kinde.Accounts.Model
{
    ...
    public partial class GetEntitlementsResponseMetadata
    {
        ...
        [JsonConstructor]
        public GetEntitlementsResponseMetadata(Option<bool?> hasMore = default, Option<string?> nextPageStartingAfter = default)
        {
    ...
    public class GetEntitlementsResponseMetadataJsonConverter : JsonConverter<GetEntitlementsResponseMetadata>
    {
        ...
        public override GetEntitlementsResponseMetadata Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (hasMore.IsSet && hasMore.Value == null)
                throw new ArgumentNullException(nameof(hasMore), "Property is not nullable for class GetEntitlementsResponseMetadata.");

            if (nextPageStartingAfter.IsSet && nextPageStartingAfter.Value == null)
                throw new ArgumentNullException(nameof(nextPageStartingAfter), "Property is not nullable for class GetEntitlementsResponseMetadata.");

            return new GetEntitlementsResponseMetadata(hasMore, nextPageStartingAfter);
        }
        ...
        public override void Write(Utf8JsonWriter writer, GetEntitlementsResponseMetadata getEntitlementsResponseMetadata, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, getEntitlementsResponseMetadata, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetEntitlementsResponseMetadata getEntitlementsResponseMetadata, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getEntitlementsResponseMetadata.NextPageStartingAfterOption.IsSet && getEntitlementsResponseMetadata.NextPageStartingAfter == null)
                throw new ArgumentNullException(nameof(getEntitlementsResponseMetadata.NextPageStartingAfter), "Property is required for class GetEntitlementsResponseMetadata.");

            if (getEntitlementsResponseMetadata.HasMoreOption.IsSet)
                writer.WriteBoolean("has_more", getEntitlementsResponseMetadata.HasMoreOption.Value!.Value);

            if (getEntitlementsResponseMetadata.NextPageStartingAfterOption.IsSet)
