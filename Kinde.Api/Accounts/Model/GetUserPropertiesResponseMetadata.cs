...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserPropertiesResponseMetadata :  IEquatable<GetUserPropertiesResponseMetadata>
    {
        /// <summary>
        ...
        public GetUserPropertiesResponseMetadata(bool hasMore = default(bool), string nextPageStartingAfter = default(string))
        {
        ...
        {
            return this.Equals(input as GetUserPropertiesResponseMetadata);
        }

        /// <summary>
        /// Returns true if GetUserPropertiesResponseMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserPropertiesResponseMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserPropertiesResponseMetadata input)
        {
            if (input == null)
                return false;
