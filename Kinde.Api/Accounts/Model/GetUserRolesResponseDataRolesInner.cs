...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserRolesResponseDataRolesInner :  IEquatable<GetUserRolesResponseDataRolesInner>
    {
        /// <summary>
        ...
        public GetUserRolesResponseDataRolesInner(string id = default(string), string name = default(string), string key = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Key = key;
        ...
        {
            return this.Equals(input as GetUserRolesResponseDataRolesInner);
        }

        /// <summary>
        /// Returns true if GetUserRolesResponseDataRolesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserRolesResponseDataRolesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserRolesResponseDataRolesInner input)
        {
            if (input == null)
                return false;
