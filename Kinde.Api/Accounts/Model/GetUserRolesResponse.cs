...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetUserRolesResponse :  IEquatable<GetUserRolesResponse>
    {
        /// <summary>
        ...
        public GetUserRolesResponse(GetUserRolesResponseData data = default(GetUserRolesResponseData), GetUserRolesResponseMetadata metadata = default(GetUserRolesResponseMetadata))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as GetUserRolesResponse);
        }

        /// <summary>
        /// Returns true if GetUserRolesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetUserRolesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetUserRolesResponse input)
        {
            if (input == null)
                return false;
