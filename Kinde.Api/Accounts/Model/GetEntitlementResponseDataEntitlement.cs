...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    public partial class GetEntitlementResponseDataEntitlement
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEntitlementResponseDataEntitlement" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEntitlementResponseDataEntitlement {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetEntitlementResponseDataEntitlement" />
    /// </summary>
    public class GetEntitlementResponseDataEntitlementJsonConverter : JsonConverter<GetEntitlementResponseDataEntitlement>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetEntitlementResponseDataEntitlement" />
        /// </summary>
        ...
        public override GetEntitlementResponseDataEntitlement Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class GetEntitlementResponseDataEntitlement.");

            if (priceName.IsSet && priceName.Value == null)
                throw new ArgumentNullException(nameof(priceName), "Property is not nullable for class GetEntitlementResponseDataEntitlement.");

            if (featureKey.IsSet && featureKey.Value == null)
                throw new ArgumentNullException(nameof(featureKey), "Property is not nullable for class GetEntitlementResponseDataEntitlement.");

            if (featureName.IsSet && featureName.Value == null)
                throw new ArgumentNullException(nameof(featureName), "Property is not nullable for class GetEntitlementResponseDataEntitlement.");

            return new GetEntitlementResponseDataEntitlement(id, fixedCharge, priceName, unitAmount, featureKey, featureName, entitlementLimitMax, entitlementLimitMin);
        }

        /// <summary>
        /// Serializes a <see cref="GetEntitlementResponseDataEntitlement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getEntitlementResponseDataEntitlement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetEntitlementResponseDataEntitlement getEntitlementResponseDataEntitlement, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getEntitlementResponseDataEntitlement, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetEntitlementResponseDataEntitlement" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getEntitlementResponseDataEntitlement"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetEntitlementResponseDataEntitlement getEntitlementResponseDataEntitlement, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getEntitlementResponseDataEntitlement.IdOption.IsSet && getEntitlementResponseDataEntitlement.Id == null)
                throw new ArgumentNullException(nameof(getEntitlementResponseDataEntitlement.Id), "Property is required for class GetEntitlementResponseDataEntitlement.");

            if (getEntitlementResponseDataEntitlement.PriceNameOption.IsSet && getEntitlementResponseDataEntitlement.PriceName == null)
                throw new ArgumentNullException(nameof(getEntitlementResponseDataEntitlement.PriceName), "Property is required for class GetEntitlementResponseDataEntitlement.");

            if (getEntitlementResponseDataEntitlement.FeatureKeyOption.IsSet && getEntitlementResponseDataEntitlement.FeatureKey == null)
                throw new ArgumentNullException(nameof(getEntitlementResponseDataEntitlement.FeatureKey), "Property is required for class GetEntitlementResponseDataEntitlement.");

            if (getEntitlementResponseDataEntitlement.FeatureNameOption.IsSet && getEntitlementResponseDataEntitlement.FeatureName == null)
                throw new ArgumentNullException(nameof(getEntitlementResponseDataEntitlement.FeatureName), "Property is required for class GetEntitlementResponseDataEntitlement.");

            if (getEntitlementResponseDataEntitlement.IdOption.IsSet)
                writer.WriteString("id", getEntitlementResponseDataEntitlement.Id);

            if (getEntitlementResponseDataEntitlement.FixedChargeOption.IsSet)
                if (getEntitlementResponseDataEntitlement.FixedChargeOption.Value != null)
                    writer.WriteNumber("fixed_charge", getEntitlementResponseDataEntitlement.FixedChargeOption.Value!.Value);
                else
                    writer.WriteNull("fixed_charge");

            if (getEntitlementResponseDataEntitlement.PriceNameOption.IsSet)
                writer.WriteString("price_name", getEntitlementResponseDataEntitlement.PriceName);

            if (getEntitlementResponseDataEntitlement.UnitAmountOption.IsSet)
                if (getEntitlementResponseDataEntitlement.UnitAmountOption.Value != null)
                    writer.WriteNumber("unit_amount", getEntitlementResponseDataEntitlement.UnitAmountOption.Value!.Value);
                else
                    writer.WriteNull("unit_amount");

            if (getEntitlementResponseDataEntitlement.FeatureKeyOption.IsSet)
                writer.WriteString("feature_key", getEntitlementResponseDataEntitlement.FeatureKey);

            if (getEntitlementResponseDataEntitlement.FeatureNameOption.IsSet)
                writer.WriteString("feature_name", getEntitlementResponseDataEntitlement.FeatureName);

            if (getEntitlementResponseDataEntitlement.EntitlementLimitMaxOption.IsSet)
                if (getEntitlementResponseDataEntitlement.EntitlementLimitMaxOption.Value != null)
                    writer.WriteNumber("entitlement_limit_max", getEntitlementResponseDataEntitlement.EntitlementLimitMaxOption.Value!.Value);
                else
                    writer.WriteNull("entitlement_limit_max");

            if (getEntitlementResponseDataEntitlement.EntitlementLimitMinOption.IsSet)
                if (getEntitlementResponseDataEntitlement.EntitlementLimitMinOption.Value != null)
                    writer.WriteNumber("entitlement_limit_min", getEntitlementResponseDataEntitlement.EntitlementLimitMinOption.Value!.Value);
                else
