...
namespace Kinde.Accounts.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetEntitlementResponseDataEntitlement :  IEquatable<GetEntitlementResponseDataEntitlement>
    {
        /// <summary>
        ...
        public GetEntitlementResponseDataEntitlement(string id = default(string), int? fixedCharge = default(int?), string priceName = default(string), int? unitAmount = default(int?), string featureKey = default(string), string featureName = default(string), int? entitlementLimitMax = default(int?), int? entitlementLimitMin = default(int?))
        {
        ...
        {
            return this.Equals(input as GetEntitlementResponseDataEntitlement);
        }

        /// <summary>
        /// Returns true if GetEntitlementResponseDataEntitlement instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEntitlementResponseDataEntitlement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEntitlementResponseDataEntitlement input)
        {
            if (input == null)
                return false;
