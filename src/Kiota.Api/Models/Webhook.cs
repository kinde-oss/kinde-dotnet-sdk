...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Kiota.Api.Models.Webhook"/> and sets the default values.
        /// </summary>
        public Webhook()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="Kiota.Api.Models.Webhook"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Kiota.Api.Models.Webhook CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Kiota.Api.Models.Webhook();
        }
        /// <summary>
