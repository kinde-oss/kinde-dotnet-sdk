...
public class WithProperty_keyItemRequestBuilderTests
{
    ...
    public async Task PutAsync_Returns200()
    {
        ...
        await client.Api.V1.Organizations["org_001"].Properties["prop_key"].PutAsync(rc =>
            rc.QueryParameters.Value = "test_value");

        handler.LastRequest!.Method.Should().Be(HttpMethod.Put);
        handler.LastRequest!.RequestUri!.PathAndQuery.Should().Contain("properties/prop_key");
        handler.LastRequest!.RequestUri!.Query.Should().Contain("value=test_value");
    }
}
